...
const navigator = createStackNavigator(
  ...
  {
    initialRouteName: "List", // 3. Now, as the property says initialRouteName, means the first screen when the app will be opened. Its set on Home and Home is the Homescreen. We will set it to Screen1 so that when App loads We get to see our first component screen.
